...
export default function Sidebar() {
	...
	return (
		<SSidebar>
			...
			<SStylefixing>
				{profileConfigurationItems.map((entry) => (
					<SidebarList brand={entry} key={`profilesublist-${entry.target}`} />
				))}
			</SStylefixing>
			<Icon>
				<FontAwesomeIcon
			...
			<SStylefixing>
				{accountConfigurationItems.map((acctentry) => (
					<SidebarList brand={acctentry} key={`acctlist-${acctentry.target}`} />
				))}
			</SStylefixing>
			<Icon>
				<FontAwesomeIcon
			...
			<SStylefixing>
				{visualsConfigurationItems.map((acctentry) => (
					<SidebarList brand={acctentry} key={`acctlist-${acctentry.target}`} />
				))}
			</SStylefixing>
		</SSidebar>
...
function SidebarList(props) {
	return (
		<Styledli>
			<AtagStyle href={`#${props.brand.target}`}>
				{' '}
