...
function AccountSettings(props) {
   const { avatar, username, biography, linked_accounts, delete_accounts } = props
   ...
   return (
      <AccSetLayout>
         ...
         <SbarMainspace>
            ...
            <svg viewBox="0 0 24 24" width="75" height="75" xmlns="http://www.w3.org/2000/svg">
            ...
            <p> Permanently remove all account data, Wuphs,
               and likes. This cannot be undone.</p>
            <DABtnWrapper>
